...
export const LOCAL_TOTAL_CASES= 'local_total_cases';
export const LOCAL_TOTAL_DEATHS= 'local_deaths';
export const LOCAL_TOTAL_RECOVERED= 'local_recovered';
export const LOCAL_TOTAL_ACTIVE_CASES= 'local_active_cases';

export const GLOBAL_TOTAL_CASES= 'global_total_cases';
export const GLOBAL_DEATHS= 'global_deaths';
export const GLOBAL_RECOVERED= 'global_recovered';
